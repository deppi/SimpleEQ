                                     ...
                                     juce::Slider & slider)
{
    ...
    g.setColour(enabled ? Colour(97u, 18u, 167u) : Colours::dimgrey);
    g.fillEllipse(bounds);
    
    g.setColour(enabled ? Colour(255u, 154u, 1u) : Colours::dimgrey);
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Bypassed", analyzerEnabledButton)
{
    ...
    analyzerEnabledButton.onClick = [safePtr]()
    {
        if(auto* comp = safePtr.getComponent())
        {
            ...
            comp->responseCurveComponent.toggleAnalysisEnablementButton(enabled);
        }
    };
